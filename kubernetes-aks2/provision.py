...
def get_vars(tools: ProvisionerTools):
    kubernetes_cluster_name = tools.vault_client.secrets.kv.v2.read_secret(path="outputs/azure")["data"]["data"]["aks2_cluster_name"]['value']
    kubeconfig = tools.vault_client.secrets.kv.v2.read_secret(path="outputs/azure")["data"]["data"]["aks2_kube_config"]["value"]
